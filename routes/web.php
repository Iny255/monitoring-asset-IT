...
Route::middleware(['auth'])->group(function () {
  ...
  Route::middleware(['role:petugas'])->group(function () {
    ...
    Route::get('/dashboard/masuk-by-kode/{kode}', [KeluarController::class, 'getMasukByKode'])->name(
      'keluar.getMasukByKode'
    );
    Route::post('/dashboard/transaksi-keluar/autofill', [KeluarController::class, 'autofillByKodeMasuk'])->name(
      'transaksi-keluar.autofill'
    );
    Route::post('/dashboard/karyawan-by-nama', [KeluarController::class, 'getKaryawanByNama'])->name(
      'keluar.getKaryawanByNama'
    );
    Route::get('/dashboard/hapus/{id}', [KeluarController::class, 'hapus'])->name('keluar.hapus');
    Route::get('/transaksi-masuk/{id}/download', [MasukController::class, 'downloadGambar'])->name(
  ...
  Route::get('/peminjaman/search-karyawan', [PeminjamanController::class, 'searchKaryawan'])->name(
    'peminjaman.searchKaryawan'
  );
