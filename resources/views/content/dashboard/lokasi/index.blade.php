...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div class="">
                <h5 style="color: navy">Data Lokasi Barang</h5>
            </div>
            <div class="">
                <a href="/dashboard/lokasi/create" class="btn btn-primary">Tambah Data Lokasi</a>
            </div>
        </div>
    </div>
    <div class="card-body">
        ...
        document.querySelectorAll('.btn-edit').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = `/dashboard/lokasi/${id}/edit`;
                    }
                });
            });
        });
