            ...
            <form action="{{ route('transaksi-keluar.update', $keluar->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" id="kode_masuk" class="form-control" value="{{ $keluar->masuk->kode_masuk }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" id="tgl_beli" class="form-control" value="{{ $keluar->masuk->tgl_beli }}"
                            readonly>
                    </div>
