            ...
            <div class="card-body">
                ...
                <form method="GET" class="row g-3 align-items-end mb-4">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" name="search" class="form-control" placeholder="Cari nama / kode user aset..."
...
document.getElementById('formEditKaryawan').action = `/dashboard/useraset/${id}`;

                            // Pastikan method override PUT agar route resource update dipanggil
                            document.getElementById('formEditKaryawan').querySelector("input[name='_method']").value = 'PUT';
